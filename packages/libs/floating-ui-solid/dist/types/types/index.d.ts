import { ComputePositionReturn, Middleware, Placement, Strategy } from '@floating-ui/dom';
...
export interface createFloatingProps {
    ...
    whileElementsMounted?: (refrence: HTMLElement, floating: HTMLElement, update: () => void) => () => void;
    elements?: {
...
export type Data = ComputePositionReturn & {
