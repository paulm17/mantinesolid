...
export const createFloating = (props) => {
    const [_reference, setReference] = createSignal(null);
    const [_floating, setFloating] = createSignal(null);
    ...
    const [floatingStylesInternal, setFloatingStylesInternal] = createSignal({
        top: '0px',
        left: '0px',
    ...
    let cleanupFn = { current: undefined };
    function update() {
    ...
    return {
        ...
        setFloatingStyles: (params) => setFloatingStylesInternal(params),
