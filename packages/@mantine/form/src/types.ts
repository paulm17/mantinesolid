...
type SetSubmitting = Setter<boolean>;
...
export type SetValues<Values> = (values: Partial<Values>) => void;
export type SetInitialValues<Values> = (values: Values) => void;
export type SetErrors = Setter<FormErrors>;
export type SetFormStatus = Setter<FormStatus>;
...
export type OnReset = (event: Event) => void;
